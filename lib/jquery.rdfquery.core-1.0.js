 ...
 * @author <a href="mailto:miel.vandersande@ugent.be">Miel Vander Sande</a>
 * @copyright (c) 2008,2009 Jeni Tennison
 * @license MIT license (MIT-LICENSE.txt)
 * @version 1.0.1
 */

//Miel Vander sande: added some extra support for datatypes
...
(function ($) {
   ...
   */
     ...
     *   </tr>
     *   <tr>
     *     <td>http://www.w3.org/2001/XMLSchema#nonNegativeInteger</td>
     *     <td>int</td>
     *   </tr>
     *   <tr>
   ...
   */
    ...
    //MVS: added support for http://www.w3.org/2001/XMLSchema#nonNegativeInteger
        ...
        for (i = 0; i < elem.childNodes.length; i += 1) {
            ...
            if (p.nodeType === 1) {
                ...
                if (hasAttributeNS(p, rdfNs, 'ID')) {
                    reified = $.rdf.resource('<#' + getAttributeNS(p, rdfNs, 'ID') + '>', {
                        base: base
                    });
